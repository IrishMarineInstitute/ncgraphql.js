...
const GlobalAttribute = _dereq_('./globalattribute.js').default;
const NetCDFVariable = _dereq_('./netcdfvariable.js').default;
const Branch = _dereq_('./branch.js').default;

const graphql = _dereq_('graphql-anywhere');
const gql = _dereq_('graphql-tag');

_dereq_('isomorphic-fetch');

_dereq_('es6-promise').polyfill();

const NetCDFReader = _dereq_('netcdfjs');
...
var parser = _dereq_('graphql/language/parser');
